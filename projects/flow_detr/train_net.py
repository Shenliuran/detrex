...
def do_train(args, cfg):
    ...
    #             if
    #             not match_name_keywords(n, ["query_projection", "key_projection", "value_projection", "out_projection",
    #                                         "out_projection_drop"])
    #             and not match_name_keywords(n, ["class_embed", "bbox_embed"])
    #             and not match_name_keywords(n, ["criterion", "input_proj"])
    #             and not match_name_keywords(n, ["learnable_temperature"])
    #             and not match_name_keywords(n, ["backbone"])
    #             and p.requires_grad
    #         ],
    #         "lr": 1e-5,
    #     },
    ...
    #         "params": [
    #             p for n, p in model.named_parameters()
    #             if match_name_keywords(n, ["criterion", "input_proj", "bbox_embed", "class_embed"])
    #                and p.requires_grad
    #         ],
    #         "lr": 1e-4,
    #     },
    ...
    #             p for n, p in model.named_parameters()
    #             if
    #             match_name_keywords(n, ["query_projection", "key_projection", "value_projection", "out_projection",
    #                                     "out_projection_drop"])
    #             and p.requires_grad
    #         ],
    #         "lr": 1e-4,
    ...
    #         "params": [
    #             p for n, p in model.named_parameters()
    #             if match_name_keywords(n, ["learnable_temperature"])
    #         ],
    #         "lr": 1e-4
    #     }
    # ]
    param_dicts = [
        {
            "params": [  # 排除
                p for n, p in model.named_parameters()
                if
                not match_name_keywords(n, ["backbone", "transformer"]) and
                not match_name_keywords(n, ["criterion", "input_proj", "bbox_embed", "class_embed"])
                and p.requires_grad
            ],
            "lr": 1e-5,
        },
        ...
        },
        {
            "params": [
                p for n, p in model.named_parameters()
                if match_name_keywords(n, ["transformer"])
            ],
            "lr": 0
        }
    ]
    optim = torch.optim.AdamW(param_dicts, 1e-4, weight_decay=1e-4)
